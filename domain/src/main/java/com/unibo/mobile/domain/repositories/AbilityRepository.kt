...
interface AbilityRepository {
    ...
    suspend fun getAbilityFromList(abilityList: List<String>) : List<Ability> //nota per impl, deve chiamare getAbilityByName in loop oppure usare un altra chiamata ad hoc verso api
